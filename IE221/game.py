...
class Game:
    ...
    def spawn_insects(self):
        ...
        if t > self.insects_spawn_timer:
            self.insects_spawn_timer = t + COCKROACH_SPAWN_TIME

            # tăng xác suất spawn ra insects theo thời gian
            ...
            if random.randint(0, 100) < nb:
                self.insects.append(Insects())
            else:
                self.insects.append(Cockroach())

            # spawn ra đối tượng cockroach sau nửa thời gian chơi
